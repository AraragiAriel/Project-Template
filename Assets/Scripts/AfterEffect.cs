...
public class AfterEffectParameters{
    ...
    public AfterEffectParameters(SpriteRenderer sr, float alpha = defaultAlpha){
        this.t = sr.transform;
    ...
    public AfterEffectParameters(SpriteRenderer sr, Sprite sprite, float alpha = defaultAlpha){
        this.t = sr.transform;
        this.duration = defaultDuration;
        this.sr = sr;
        this.alpha = alpha;
...
{
    public static void Emit(AfterEffectParameters parameters){
        AfterEffect afterEffect = Instantiate(ResourcesSystem.data.afterEffect, parameters.t.position, Quaternion.identity);
    ...
    public void Set(AfterEffectParameters parameters){
